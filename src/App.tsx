...
function App() {
  ...
  // Syntax highlighting for the expression
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 space-y-6 border border-gray-100">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <div className="absolute inset-0 font-mono text-sm pointer-events-none px-4 py-3"
                  ...
                  <textarea
                    ...
                    className="w-full h-64 px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 font-mono text-sm bg-transparent"
                        ...
                        <div className="flex gap-3">
                          ...
                          {inputTypes[key] === 'text' ? (
                            <input
                              ...
                              value={keyValues[key] || ''}
                              readOnly
                              className="flex-1 px-3 py-2 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
